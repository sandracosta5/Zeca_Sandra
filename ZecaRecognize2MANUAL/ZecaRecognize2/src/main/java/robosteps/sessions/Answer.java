...
public class Answer {
    ...
    public void wrongAnswerVerbal(){
        settings();
        int j = randNum(2);
        if(j == 1) myRobot.speak("Uups. Présta atenção. Vamos a outra.");
        else myRobot.speak("Ohoooh, vamos tentar outra.");
    ...
    public void wrongAnswerVerbalMovement(){
        ...
        int j = randNum(2);
        myRobot.playAnimation(wrongAnswer);
        if(j == 1) {myRobot.speak("Uups. Presta atenção. Vamos a outra.");}
        else myRobot.speak("Ohoooh, vamos tentar outra.");
        Robosteps.sleep(5000);
        myRobot.playAnimation(blink);
    }
    ...
    */
    public void rightAnswerVerbal(){
        ...
        else if (j == 8) myRobot.speak("UAAU! Boa!");
    ...
    */
    public void rightAnswerVerbalMovement(){
        ...
        else if (j == 8) {myRobot.speak("UAAU! Boa!"); myRobot.playAnimation(rightAnswer04);}
